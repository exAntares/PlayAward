Shader "Simumak 2.0/LightEffects/GodRays_BB" {
...
//	Blend One OneMinusSrcColor
	...
	v2f vert (appdata_full v)
	{
		...
		o.pos	= mul(UNITY_MATRIX_P,mul(MV, mdlPos));		
		
		//mdlPos = mul(UNITY_MATRIX_P, 
        //     mul(UNITY_MATRIX_V, float4(0.0, 0.0, 0.0, 1.0))
        //      - float4(mdlPos.x, mdlPos.z, 0.0, 0.0));
